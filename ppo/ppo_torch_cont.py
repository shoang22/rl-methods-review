...
class Agent:
    ...
    def choose_action(self, obs):
        ...
        probs = T.squeeze(dist.log_prob(action)).item()  # return integer
    ...
    def learn(self):
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                ...
                actions = T.tensor(action_arr[batch]).unsqueeze(1).to(self.actor.device).float()  # need to increase dimension of tensor from 1 to 2 to match state
